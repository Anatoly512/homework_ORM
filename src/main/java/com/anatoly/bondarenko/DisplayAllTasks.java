...
public class DisplayAllTasks {
    ...
    public void ShowAllTasks() throws SQLException {
        ...
        //  Вывести дату, названия и посчитать количество разработчиков у всех проектов
        developersService.findAllProjectsAndItsAmountOfDevelopers();
    ...
    public void displaySkills() throws SQLException {
